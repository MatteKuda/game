...
const FIXTURES := [
	...
	{"id": "soguk", "name": "Soğuk Oda", "desc": "Süt, ayran, peynir ve içecekler bozulmaz. Soğuk oda yoksa depodaki soğuk ürünlerin %30'u her gece bozulur. +150 kapasite.", "kind": "depot", "cat": "Odalar", "w": 3, "d": 2, "cost": 7800, "stage": 2, "depot": 150, "cold": true, "room": "SOĞUK ODA"},
