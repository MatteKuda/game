export type Accessory = 'backpack' | 'flatcap' | 'briefcase' | 'totebag' | 'cane';
...
export const ARCHETYPES: Archetype[] = [
  {
    ...
    budget: [25, 60], wants: { cips: 5, cikolata: 4, kola: 5, biskuvi: 2, simit: 2 }, listSize: [1, 2],
  ...
  },
  {
    ...
    budget: [30, 90], wants: { ekmek: 6, simit: 3, ayran: 4, biskuvi: 3, sut: 3, domates: 3 }, listSize: [1, 3],
  ...
  },
  {
    ...
    budget: [60, 180], wants: { kola: 4, ayran: 3, simit: 4, cips: 2, cikolata: 2, biskuvi: 1 }, listSize: [1, 3],
  ...
  },
  {
    ...
    budget: [120, 320], wants: { ekmek: 3, sut: 4, domates: 4, elma: 4, deterjan: 2, biskuvi: 2, ayran: 2, cikolata: 1 }, listSize: [3, 5],
