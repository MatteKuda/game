...
const KEYS: Key[] = [
  ...
  { h: 21.0, sun: C(0x7f8fe0), sunI: 0.45, sky: C(0x4a5690), ground: C(0x2e2a3e), hemiI: 0.6, top: C(0x1d2552), bottom: C(0x5a5a9a), fog: C(0x3f4478), exp: 1.05 },
  { h: 24.0, sun: C(0x6d7bd6), sunI: 0.3, sky: C(0x33406e), ground: C(0x2a2433), hemiI: 0.5, top: C(0x141b3d), bottom: C(0x3c3c70), fog: C(0x2f3560), exp: 1.05 },
];
...
export class Renderer {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.bloom = new UnrealBloomPass(new THREE.Vector2(window.innerWidth, window.innerHeight), 0.35, 0.55, 0.9);
